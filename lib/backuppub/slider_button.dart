...
class SliderButton extends StatefulWidget {
  ...
  //added by NG JIA XUE
  final bool swipeFromRight;
  final Function(DismissDirection) onDismissed;
  SliderButton({
    @required this.action,
    @required this.swipeFromRight,
...
class _SliderButtonState extends State<SliderButton> {
  ...
  Widget _control() => Container(
        ...
        alignment: widget.swipeFromRight
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Dismissible(
              key: UniqueKey(),
              direction: widget.swipeFromRight
                  ? DismissDirection.endToStart
                  : DismissDirection.startToEnd,
              dismissThresholds: {
                widget.swipeFromRight
                    ? DismissDirection.endToStart
              ...
              child: Container(
                ...
                padding: EdgeInsets.only(
                  left: widget.swipeFromRight
                      ? 0
                      : (widget.height - widget.buttonSize) / 2,
                  right: widget.swipeFromRight
                      ? (widget.height - widget.buttonSize) / 2
                      : 0,
                ),
                child: widget.child ??
